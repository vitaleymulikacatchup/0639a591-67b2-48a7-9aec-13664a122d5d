...
export const metadata: Metadata = {
  title: "BrewCraft Coffee - Premium Artisan Coffee Shop",
  description: "Experience exceptional coffee at BrewCraft Coffee. Artisan roasted beans, expert brewing, and a welcoming atmosphere for coffee lovers.",
  keywords: ["coffee shop", "artisan coffee", "premium beans", "espresso", "latte", "coffee roasting", "cafe"],
